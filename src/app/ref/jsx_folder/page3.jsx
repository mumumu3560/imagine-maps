...
const onEachFeature = (feature, layer) => {
  ...
  layer.bindPopup (feature.properties.N03_004/*+'<b>'+feat.properties.t+'</b><br>団体コード＝ '+feat.properties.c */);
...
function App() {
  ...
  return (
    <div>
      ...
      <MapContainer center={center} zoom={8} zoomControl={false} id="map" style={{ height: '100vh', width: '100%' }}>
        <TileLayer
